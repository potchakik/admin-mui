...
const ExtendedTopstories = () => {
  ...
  useEffect(() => {
    axios
      .get("https://dev-newsapp.abs-cbnnews.com/extended/list/topstories.json")
      .then((res) => setDatas(res.data.items));
  }, []);

  //  const isError = () => {
  //    return <Alert severity="error">No records shown</Alert>;
  //  };
...
export default ExtendedTopstories;
